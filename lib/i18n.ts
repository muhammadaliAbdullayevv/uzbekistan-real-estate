...
const translations = {
  uz: {
    ...
    account: {
      ...
      locationDetectHint: "Joriy joylashuvingiz asosida viloyat va tumanni avtomatik to'ldiradi.",
      ...
      notSet: "Kiritilmagan",
      incompleteProfileTitle: "Profilingizni to'ldiring",
      incompleteProfileBody:
        "Barcha imkoniyatlardan foydalanish uchun telefon raqamingiz va hududingizni kiriting.",
    ...
    addListing: {
      ...
      form: {
        ...
        districtSelectPrompt: "Tanlang",
        cityNeighborhood: "Mo'ljal",
    ...
    aiUychi: {
      ...
      send: "Yuborish",
      sending: "O'ylanmoqda...",
      emptyState: "Uy-joy topishda yordam bering deb so'rang — masalan, \"Chilonzorda 2 xonali, 500 dollargacha ijara\".",
    ...
    owner: {
      ...
      statsPending: "Kutilmoqda",
      statsActive: "Faol e'lonlar",
      statsUsers: "Foydalanuvchilar",
      statsBlocked: "Bloklangan",
      rejectConfirm: "Ushbu e'lonni rad etishni tasdiqlaysizmi?",
  ...
  ru: {
    ...
    account: {
      ...
      locationDetectHint: "Автоматически заполнит область и район по вашему текущему местоположению.",
      ...
      notSet: "Не указано",
      incompleteProfileTitle: "Заполните профиль",
      incompleteProfileBody:
        "Укажите номер телефона и регион, чтобы пользоваться всеми возможностями.",
    ...
    addListing: {
      ...
      form: {
        ...
        districtSelectPrompt: "Выберите",
        cityNeighborhood: "Ориентир",
    ...
    aiUychi: {
      ...
      send: "Отправить",
      sending: "Думаю...",
      emptyState: "Спросите то, что ищете — например, «2-комнатная в Чиланзаре, аренда до 500 долларов».",
    ...
    owner: {
      ...
      rejectConfirm: "Отклонить это объявление?",
